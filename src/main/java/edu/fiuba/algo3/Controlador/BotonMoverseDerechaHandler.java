...
public class BotonMoverseDerechaHandler implements EventHandler<ActionEvent> {
    ...
    public BotonMoverseDerechaHandler(Unidad unaUnidad,Button unBoton, Text unTexto){
        unidad = unaUnidad;
        boton = unBoton;
        texto = unTexto;
    }
